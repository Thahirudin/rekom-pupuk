...
@section('content')
    <div class="p-5 border border-gray-200 rounded-md">
        ...
        @endif
        <form class="mx-auto" action="{{ route('product.update', ['product' => $product]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-5">
                ...
                <input type="text" id="name" name="name"
                    ...
                    placeholder="Input Your Name" required value="{{ $product->name }}" />
            </div>
            <div class="mb-5">
                ...
                <input type="text" id="nutrients" name="nutrients"
                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                    placeholder="Input Your nutrients" required value="{{ $product->nutrients }}" />
            </div>
            <div class="mb-5">
                ...
                <input type="text" id="landType" name="landType"
                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                    placeholder="Input Your landType" required value="{{ $product->landType }}" />
            </div>
            <div class="mb-5">
                ...
                <select id="age" name="age"
                    ...
                    <option value="<5 Tahun">
                        <5 Tahun</option>
                    <option value="5-10 Tahun" {{ $product->age == '5-10 Tahun' ? 'selected' : '' }}>>5-10 Tahun</option>
                    <option value="10-15 Tahun" {{ $product->age == '10-15 Tahun' ? 'selected' : '' }}>10-15 Tahun</option>
                    <option value="15-20 Tahun">{{ $product->age == '15-20 Tahun' ? 'selected' : '' }}>15-20 Tahun</option>
                    <option value="Semua Umur" {{ $product->age == 'Semua Umur' ? 'selected' : '' }}>Semua Umur</option>
                </select>
            </div>
            <div class="mb-5">
                ...
                <input type="text" id="condition" name="condition"
                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                    placeholder="Input Your condition" required value="{{ $product->condition }}" />
            </div>
            <div class="mb-5">
                <label for="price" class="block mb-2.5 text-sm font-medium text-heading">price</label>
                <input type="number" id="price" name="price"
                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                    placeholder="Input Your price" required value={{ $product->price }} />
            ...
            <div class="mb-5">
                ...
                <input type="text" id="benefit" name="benefit"
                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                    placeholder="Input Your benefit" required value="{{ $product->benefit }}" />
            </div>
            <div class="mb-5">
